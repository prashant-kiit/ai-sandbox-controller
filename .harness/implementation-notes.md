...
Milestone 2 of 10 done. Project scaffold, dependencies, and agent core
loop (OpenAI-based, post-pivot) committed.
...
1. Run G0 + L1 BUILD on milestone 3 (tool schema — Step 6, OpenAI function-calling envelope).
